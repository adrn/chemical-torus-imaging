...
% - Q from Chris Hayes: It’s not clear to me specifically how this would affect
%   your modeling, but just to see if you can think of anything, what effect
%   would it have that you should have some kind of bias/selection function that
%   relates the metallicities (and therefore other abundances) to z height,
%   because of the differing target selections used for the disk and halo in
%   APOGEE, which is essentially that halo pointing (which would be giving you
%   your larger zs) have a bluer color cut than the disk (which would give your
%   low zs for the most part)?  So to some extent you are biased against lower
%   metallicities at low z and more likely to get them at higher z, could this
...
% - Jo Bovy, Jason Sanders, Payel Das, James Binney, Paul McMillan, Scott Tremaine -- all have
%   worked on DF modeling or extended DF torus things
% - Joss Bland-Hawthorn
% - Martin Weinberg
...
\begin{abstract}\noindent
  ...
  stellar labels, e.g., stellar ages) to measure the Galactic mass distribution.
  ...
  % TODO: Rachael suggests rephrasing "isoclinics"
