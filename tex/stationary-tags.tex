...
\begin{abstract}\noindent
  ...
  In steady state the distributions of any tags must be invariant with respect to
  ...
  they are better than Jeans models because they
  don't require knowledge of the survey selection function, and they don't require
  measurements of second moments of velocities (or anything else).
  We perform a classical-statistics demonstration with
  red-giant stars from the \apogee\ surveys:
