...
for stars, which depend on the mass distribution of the Milky Way.
Here we represent the density distribution (or gravitational potential) of the Milky Way using a parametrized, three-component mass model consisting of a spherical Hernquist bulge \citep{Hernquist:1990}, an axisymmetric Miyamoto-Nagai disk \citep{Miyamoto:1975}, and a spherical Navarro-Frenk-White dark matter halo \citep{Navarro:1996}.
