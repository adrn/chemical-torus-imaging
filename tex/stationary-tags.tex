...
\begin{abstract}\noindent
  ...
  Under these assumptions there are a number of tools for 
  inferring potential parameters given observations of stellar kinematics.
  However, contemporary spectroscopic surveys measure
  not just kinematics but also many other stellar properties, and they do so for
  huge samples of individual stars.
  ...
  This method exploits the fact that, in steady state, stellar labels vary
  systematically with orbit characteristics (actions), yet must be
  invariant with respect to orbital phases (time-dependent conjugate
  angles).
  Thus, the orbital foliation of phase space must coincide with the surfaces along
  ...
  selection function and they do not involve taking velocity dispersions.
