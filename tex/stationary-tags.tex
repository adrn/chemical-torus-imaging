...
and stellar tags.
\HOGGTODO{do you want to say more about using the spiral as a PROBE?}
Beyond the Galactic disk in the stellar halo, like Jeans modeling, \methodname\
will be biased by the existence of unmixed substructures (streams, shells, and
...
% TODO: Selection - Discuss in the context of our application, and of other applications in the MW
...
% TODO: Integrable - Discuss in the context of our application, and of other applications in the MW
% Technically we require non-resonant - not just integrable, but we need
%   globally integrable so that the actions are continuous. But at the precision
%   we are working, we don't think this is the showstopper


% TODO: Invariant abundances - Discuss in the context of our application, and of other applications in the MW
...
% TODO: Measurable gradients - Discuss in the context of our application, and of other applications in the MW
