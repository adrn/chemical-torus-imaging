...
% TODO left off here: audit that we say the right things about Jeans...
...
relative to the midplane $z_\odot$, the solar $z$ velocity relative to the local
standard of rest $v_{z, \odot}$, the disk mass parameter \mratio, and the disk
scale height \hz\ \citep[the Miyamoto--Nagai scale height parameter, not an
exponential scale height;][]{Miyamoto:1975}.
For each setting of these parameters $\mratio, \hz, z_\odot, v_{z, \odot}$, we
...
and references therin), both \abunratio{Mg}{Fe} and \abunratio{Si}{Fe} suggest
...
0.27 \pm 0.01~\kpc$, $z_\odot = 16.9 \pm 0.8~\pc$, and $v_{z, \odot} = 8.8 \pm
0.2~\kms$.
...
0.28 \pm 0.01~\kpc$, $z_\odot = 20.6 \pm 0.9~\pc$, and $v_{z, \odot} = 8.4 \pm
0.3~\kms$
