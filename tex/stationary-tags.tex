...
Zhai:2018, Buch:2019}, investigators make use of the Jeans equations, which relate
spatial derivatives of velocity second moments to potential derivatives.
The equations are correct for any
collisionless tracer population of stars, but implementing Jeans models in practice
...
distribution function, (coordinate) separability of the \acronym{DF}, simple
parametrizations of the mass model (e.g., integrable models) and \acronym{DF},
among others.
