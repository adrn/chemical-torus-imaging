...
\item
  ...
  can't depend on the conjugate angles. In a good model of the
  abundances as a function of 6-dimensional phase-space coordinates,
  the abundances will depend only on the actions.
\item
  Abundance gradients taken in 6-dimensional phase space will be
  perpendicular, everywhere, to the orbital 3-tori in phase space.
\item
  At every location in 6-d phase space, there are a set of 6-d
  ...
  3-d subspace, and this subspace will be orthogonal to the surfaces
  of the orbital tori.
\item
  The orbital tori will be level 3-surfaces in 6-d phase space of any
  moments or statistics of the element-abundance distribution.
\end{itemize}

This point is illustrated graphically in \figurename~\ref{fig:zvz-mgfe}:
