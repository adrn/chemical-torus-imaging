...
% - We are similar to assumptions in Schwarzchild (agnostic to DF over
...
\begin{abstract}\noindent
  ...
  interpreted in an approximation in which the gravitational potential is
  treated as simple and integrable and the distribution function time-invariant.
