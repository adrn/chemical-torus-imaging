...
\begin{figure}[!tp]
  ...
  \end{center}
  \caption{%
    \textsl{Left panel:} Two orbits projected onto $z, v_z$ space, colored by
    the angle $\theta_z$ that is conjugate to vertical action $J_z$.
    Because each orbit paints a 3-torus in 6-dimensional phase space, it projects
    to a finite-width band in $z, v_z$ sspace.
    ...
    APW: HOGG DOES THINK WE SHOULD KEEP THIS FIGURE, BECAUSE IT HELPS EXPLAIN THE NEXT ONE.
  \label{fig:zvz-demo}
  }
\end{figure}
