...
as separability of the \acronym{DF}, or require simple parametrizations of the
\acronym{DF} in order to execute these analyses.
Generic approaches here typically require parametrized models for the \acronym{DF} and for the gravitational force field (or mass distribution) and are computationally prohibitive for large data sets or flexible model forms \citep[see, e.g.,][]{Magorrian, Binney, Sanders, McMillan, Walker, Penarrubia}.
...
\citep[e.g.,][]{Oort, Bahcall, Garbari, Buch, Schutz}, ... other applications.
...
Galactic disk and halo \citep{Antoja, Eilers, halo}.
...
\textbf{APW SAYS: Expand out again, make sure to state how general this idea?}

\section{Methodological Generalities and Motivation}
