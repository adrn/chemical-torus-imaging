...
\begin{figure}[!tp]
  ...
  \end{center}
  \caption{%
    Parameters of the smooth sine-and-cosine fit to the dependence of abundance
    deviation on vertical angle $\theta_z$, as a function of the disk-mass
...
HOGG SAY: The fact that the alpha/m and fe/h type abundances give
