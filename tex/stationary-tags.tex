...
\TODO{We select the low-alpha sequence primarily because...}
...
\item[properly selected] The selection function depends on position (or velocity) in the
...
\TODO{In fact, we repeated all analyses in this paper using the red clump
selection in Bovy whatever and find the same things...}
