...
In the experiments performed above, we used the means of
a set of hand-chosen abundance-ratio deviations
as our invariant tags. There are many other choices we could have made.
...
as stellar ages. We could even have used the \emph{other actions $J_R, J_\phi$}
